<!-- TOC -->
* [Q-1 - Wha is JIT?](#q-1---wha-is-jit)
* [Q-2 - What is class Loader?](#q-2---what-is-class-loader)
* [Q-3 - What ar diff types of classloaders?](#q-3---what-ar-diff-types-of-classloaders)
...
* [Q-35 Whare are some use cases of reflection](#q-35-whare-are-some-use-cases-of-reflection)
...
* [Q-41 When ExecutorService was introduced in java?](#q-41-when-executorservice-was-introduced-in-java)
* [Q-42 Whats the diff b\w process and threads?](#q-42-whats-the-diff-bw-process-and-threads)
* [Q-42 By default main thread doesn't terminate until the child threads are done, then what's the point of join() method?](#q-42-by-default-main-thread-doesnt-terminate-until-the-child-threads-are-done-then-whats-the-point-of-join-method)
* [Q-42 What is the diff b/w objects and references?](#q-42-what-is-the-diff-bw-objects-and-references)
* [Q- Exaplain stack and heap memory regions in the context of threads?](#q--exaplain-stack-and-heap-memory-regions-in-the-context-of-threads)
...
* [Q- Mention some atomic operations?](#q--mention-some-atomic-operations)
...
* [Q-How many threads gets initiated when you start a basic java program?](#q-how-many-threads-gets-initiated-when-you-start-a-basic-java-program)
...
* [Q- Do `doubles` and `float` type overflow?](#q--do-doubles-and-float-type-overflow)
* [Q-What is shadowing?](#q-what-is-shadowing)
* [Q-var is used for Local Variable Type Inference (LVTI). Can  we use it to declare variables?](#q-var-is-used-for-local-variable-type-inference-lvti-can--we-use-it-to-declare-variables)
...
* [Q-What is string interning?](#q-what-is-string-interning)
...
* [Q-What is the differnece b/w `isEmpty()` and `isBlank()` method of String object?](#q-what-is-the-differnece-bw-isempty-and-isblank-method-of-string-object)
