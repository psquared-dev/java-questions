...
Shadowing is when a local variable is legally declared, but another declaration that can be
qualified is not used or accessed because the local variable takes precedence. Here is an example:
